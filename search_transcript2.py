...
output_path = r'C:\Users\Administrator\Desktop\ALFAZA CELL\APLIKASI BARU\ALPHA(apk-toko)\search_out2.txt'
...
for line in lines:
    try:
        ...
        if 'Buka Toko' in content and data.get('type') == 'USER_INPUT':
