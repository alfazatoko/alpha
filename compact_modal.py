                            ...
                            return (
                              <button
                                ...
                                className={`px-3 py-1 rounded-full text-[9px] font-black tracking-wide whitespace-nowrap transition-all border ${
                                  isSelected 
                                    ? (isLight ? "bg-emerald-500 text-white border-emerald-500 shadow-sm shadow-emerald-500/20" : "bg-emerald-500 text-white border-emerald-500 shadow-sm shadow-emerald-500/20")
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center justify-center shrink-0 pl-1 gap-1.5">
                                  ...
                                  <div className={`w-3.5 h-3.5 rounded-full flex items-center justify-center border-2 transition-all ${isSel ? "border-emerald-500 bg-emerald-500" : (isLight ? "border-slate-300 bg-slate-50" : "border-slate-600 bg-slate-800")}`}>
                      ...
                      <div className={`shrink-0 border-t p-3 z-20 mt-auto ${isLight ? 'bg-white border-slate-200' : 'bg-slate-900 border-white/10'}`}>
                         <div className="flex items-center justify-between">
                           <div className="flex items-center gap-2.5">
                             ...
                             <div>
                               <p className={`text-[9px] font-black ${isLight ? 'text-slate-800' : 'text-slate-200'}`}>1 Produk Dipilih</p>
                               <p className={`text-[8px] font-bold truncate max-w-[100px] ${isLight ? 'text-slate-500' : 'text-slate-400'}`}>{selectedProduct?.name || 'Belum ada'}</p>
                             </div>
                           </div>
                           <button
                        ...
                        <div className={`rounded-xl p-2.5 shadow-sm border flex items-center justify-between ${isLight ? 'bg-white border-slate-200' : 'bg-slate-900 border-white/10'}`}>
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className={`text-[7px] font-bold mt-0.5 ${isLight ? 'text-slate-500' : 'text-slate-400'}`}>Total: {formQuantity} pcs</p>
                            </div>
                          </div>
                        ...
                        <div className={`rounded-xl p-2 shadow-sm border flex items-center justify-between ${isLight ? 'bg-emerald-50 border-emerald-200' : 'bg-emerald-900/20 border-emerald-500/30'}`}>
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className={`text-[14px] font-black leading-none mt-0.5 ${isLight ? 'text-emerald-600' : 'text-emerald-400'}`}>Rp {((selectedProduct?.sellingPrice || 0) * formQuantity).toLocaleString('id-ID')}</p>
                            </div>
                          </div>
                        </div>
                      </div>
