            ...
            {[
              ...
              <button 
                ...
                className={cn(
                  ...
                  screenSize === size.id ? "bg-blue-600 border-blue-600 text-white shadow-lg shadow-blue-100" : "bg-white border-gray-300 text-gray-600 hover:border-blue-200 hover:text-blue-400"
                )}
              >
                <i className={cn("fa-solid text-sm", size.icon)}></i>
