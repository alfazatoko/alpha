...
old_logic = """  // Auto Keterangan Logic
  React.useEffect(() => {
    if (!isKetAuto) return
    let autoText = ''
...
new_logic = """  // Auto Keterangan Logic (Prefix calculation)
...
# 3. Replace Keterangan UI
old_ui = """          <div className="relative group px-2">
...
new_ui = """          <div className="relative group px-2">
          <div className="flex justify-between items-center mb-1 px-1">
            <label className="block text-[10px] font-black text-gray-700 uppercase tracking-widest flex items-center gap-1.5">
              <i className="fa-solid fa-align-left text-gray-400"></i> Keterangan
            </label>
